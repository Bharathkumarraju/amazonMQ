...
public class Main {
    ...
    private final static String ACTIVE_MQ_USERNAME = "user1";
    private final static String ACTIVE_MQ_PASSWORD = "Test@12345";
    private final static String QUEUE_NAME = "queues.queue2";
